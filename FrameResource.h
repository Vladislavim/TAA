...
{
    // --- базовые матрицы / то, что уже было ---
    ...
    // === Ќќ¬ќ≈: режим теней ===
    int                 ShadowMode = 0;           // 0 = Luna, 1 = м€гкий
    DirectX::XMFLOAT3   ShadowPad = { 0.0f, 0.0f, 0.0f };

    // === Ќќ¬ќ≈: атмосфера (Exponential Height Fog) ===
    float               AtmosphereGlobalDensity = 0.02f; // базова€ плотность
    float               AtmosphereHeightFalloff = 0.1f;  // спад плотности с высотой
    float               AtmosphereCleanliness = 0.5f;  // 0 = гр€зно, 1 = чисто
    ...
    float padOutline;            // дл€ выравнивани€ (чтобы cb был кратен 16 байт)
};
